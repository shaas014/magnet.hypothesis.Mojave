...
#ggplot(frequency, aes(net.treatment, rate.per.flower)) + geom_boxplot() + ylab("rate per flower per unit time") + facet_wrap(~year) + coord_flip()

ggplot(frequency, aes(net.treatment, rate.per.flower.hr)) + geom_boxplot() + ylab("rate per flower per hour") + facet_wrap(~year) + coord_flip()

#ggplot(frequency, aes(net.treatment, rate.per.flower, fill = year)) + geom_bar(stat= "identity") + ylab("rate per flower per unit time") + scale_fill_brewer(palette = "YlGn") + coord_flip()

ggplot(frequency, aes(net.treatment, visitations.hr)) + geom_boxplot() + ylab("mean visit duration (min) per hour recorded") + facet_wrap(~year) + coord_flip()

#ok, only spend 1 min per hr?

ggplot(frequency, aes(net.treatment, mean.insect.RTU)) + geom_boxplot() + ylab("mean RTU richness") + facet_wrap(~year) + coord_flip()

#net treatment per RTU
ggplot(frequency.by.RTU, aes(net.treatment, rate.per.flower.hr)) + geom_boxplot() + ylab("rate per flower per hour") + facet_wrap(~year*insect.RTU) + coord_flip()

ggplot(frequency.by.RTU, aes(net.treatment, rate.per.flower.hr, fill = insect.RTU)) + geom_boxplot() + ylab("rate per flower per hour") + scale_fill_brewer(palette = "Blues") +
  facet_wrap(~year) + coord_flip()

ggplot(frequency.by.RTU, aes(net.treatment, visitations.hr)) + geom_boxplot() + ylab("rate per flower per hour") + facet_wrap(~year*insect.RTU) + coord_flip()

ggplot(frequency.by.RTU, aes(net.treatment, visitations.hr, fill = insect.RTU)) + geom_boxplot() + ylab("rate per flower per hour") + scale_fill_brewer(palette = "Blues") +
  facet_wrap(~year) + coord_flip()
...
#do both years at once with net treatments
