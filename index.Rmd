...
m <- glm(rate.per.flower.mean.time~net.treatment + insect.RTU %in% rep + mean.temp, family = "poisson", data = freq.2015)
anova(m, test = "Chisq")
lsmeans(m, pairwise~net.treatment, adjust="tukey")

m <- glm(rate.per.flower.mean.time~net.treatment*insect.RTU %in% rep + mean.temp, family = "poisson", data = freq.2016)
anova(m, test = "Chisq")
lsmeans(m, pairwise~net.treatment, adjust="tukey")
